    ...
    if (tokenStatus === "validating") {
        return (
            <div className="flex flex-col items-center justify-center py-10 gap-4">
                ...
                <p className="text-gray-500 text-sm font-medium">Validating your reset link…</p>
            </div>
        );
    }
    ...
    if (tokenStatus === "invalid") {
        return (
            <div className="text-center py-4">
                ...
                <h1 className="text-2xl font-black text-gray-900 mb-2">Link expired or invalid</h1>
                <p className="text-gray-500 text-sm mb-8 leading-relaxed">
                    This password reset link has expired or is invalid. Reset links are
                    only valid for <span className="font-semibold text-gray-700">24 hours</span>.
                ...
                <p className="text-sm text-gray-400">
                    <Link href="/" className="text-emerald-600 hover:text-emerald-700 font-medium transition">
                        ← Back to Sign In
                    </Link>
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                {newPassword && (
                    <div className="mb-4">
                        ...
                        <p className={`text-xs font-medium ${strength.score <= 2 ? "text-red-500" :
                        ...
                        <ul className="space-y-1">
                            {requirements.map((r) => (
                                <li key={r.label} className="flex items-center gap-2">
                                    <span
                                        className={`flex-shrink-0 h-4 w-4 rounded-full flex items-center justify-center transition-colors ${r.test ? "bg-emerald-500" : "bg-gray-200"
                                            }`}
                                    >
                                        {r.test && (
                                    ...
                                    <span className={`text-xs ${r.test ? "text-emerald-700 font-medium" : "text-gray-500"}`}>
                                        {r.label}
                                    </span>
                                </li>
                            ))}
                ...
                <div className="mb-6">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                            className={`w-full rounded-xl border bg-gray-50 pl-10 pr-12 py-3 text-sm focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition placeholder-gray-400 ${confirmPassword && newPassword !== confirmPassword
                                    ? "border-red-300"
                                    : "border-gray-200"
                                }`}
                            required
                ...
                <button
                    type="submit"
                    disabled={submitStatus === "loading" || requirements.some((r) => !r.test) || newPassword !== confirmPassword}
