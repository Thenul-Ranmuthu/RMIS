...
export default function VerifyEmailPage() {
    ...
    const getEndpoint = (role: string, code: string): string => {
        switch (role) {
            case "Technician":
                return `${API_BASE_URL}/auth/technician/register/${code}`;
            case "Company":
                return `${API_BASE_URL}/auth/company/register/${code}`;
            case "Public User":
            default:
                return `${API_BASE_URL}/auth/user/register/${code}`;
        }
    };
    ...
    const handleResend = async () => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/sendMail/${email}`, {
                method: "GET",
            });
